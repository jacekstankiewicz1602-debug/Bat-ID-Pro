...
def set_analysis_location():
    ...
    if args.area == "Bavaria":
        ...
        cfg.LABELS_FILE = 'batty_birdnet_analyzer/checkpoints/bats/v1.0/BattyBirdNET-Bavaria-256kHz_Labels.txt'
...
if __name__ == "__main__":
    ...
    cfg.CODES_FILE = 'batty_birdnet_analyzer/eBird_taxonomy_codes_2021E.json'
    cfg.LABELS = utils.readLines(cfg.LABELS_FILE)
